...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/myjobadsdetail',
          requireAuth: true,
          builder: (context, params) => MyjobadsdetailWidget(
            adRef: params
                .getParam('adRef', ParamType.DocumentReference, false, ['ads']),
          ),
        ),
        FFRoute(
          name: 'detailedprofilecandidate',
          path: '/detailedprofilecandidate',
          requireAuth: true,
          builder: (context, params) => DetailedprofilecandidateWidget(
            candidateProfile: params.getParam('candidateProfile',
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatMessagesWidget(
            chatDoc: params.getParam(
                'chatDoc', ParamType.DocumentReference, false, ['chats']),
          ),
        ),
        FFRoute(
          name: 'chat',
        ...
        FFRoute(
          ...
          builder: (context, params) => PaymentsuccessWidget(
            validTill: params.getParam('validTill', ParamType.DateTime),
            adLimits: params.getParam('adLimits', ParamType.int),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/updateAd',
          requireAuth: true,
          builder: (context, params) => UpdateAdWidget(
            adRef: params
                .getParam('adRef', ParamType.DocumentReference, false, ['ads']),
          ),
        ),
