                    ...
                    Expanded(
                      child: AuthUserStreamWidget(
                        builder: (context) => Builder(
                          builder: (context) {
                            final profiles =
                                (currentUserDocument?.viewedProfile.toList() ??
                                        [])
                                    .toList();
                              ...
                              itemBuilder: (context, profilesIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: StreamBuilder<UsersRecord>(
                                    stream:
                                        UsersRecord.getDocument(profilesItem),
                                                      ...
                                                      () => _model
                                                          ...
                                                          ? _model
                                                              .removeFromSelectedProfiles(
                                                                  profilesItem)
                                                          : _model
                                                              .addToSelectedProfiles(
                                                                  profilesItem),
                                                    );
                                                  },
                                                  value: _model.selectedProfiles
                                                      .contains(profilesItem),
                                                  onIcon: Icon(
                                                    Icons.check_circle,
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: SendMessageWidget(
                                        candidateList: _model.selectedProfiles,
                                      ),
                                    ),
                                  );
                                },
