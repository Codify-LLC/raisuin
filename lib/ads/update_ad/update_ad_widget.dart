                          ...
                          children: [
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    setState(() {
                                      _model.gender =
                                          Gender.values.toList().cast<Gender>();
                                    });
                                  },
                                  child: Text(
                                    'Select All',
                                  ...
                                  child: Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                        ...
                                        _model.levelValue ??= updateAdAdsRecord
                                            .educationRequired.educationType,
                                      ),
                                      options: const [
                                        'Undergraduate',
                                        'Postgraduate',
                                    ...
                                    child: Container(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        margin: const EdgeInsetsDirectional.fromSTEB(
                                            12.0, 4.0, 12.0, 4.0),
                                        hidesUnderline: true,
                                        disabled: (_model.levelValue == null ||
                                                _model.levelValue == '') &&
                            ...
                            Padding(
                              ...
                              child: FlutterFlowChoiceChips(
                                ...
                                onChanged: (val) => setState(() =>
                                    _model.regionallanguageschipsValues = val),
                                selectedChipStyle: ChipStyle(
                                  backgroundColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  textStyle: FlutterFlowTheme.of(context)
                                ...
                                multiselect: true,
                                initialized:
                                    _model.regionallanguageschipsValues != null,
                                alignment: WrapAlignment.start,
                                controller: _model
                              ...
                              onPressed: () async {
                                await widget.adRef!.update({
                                  ...createAdsRecordData(
                                    ...
                                    requirementFor: _model.requirementForValue,
