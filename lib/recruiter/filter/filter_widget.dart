                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          if (((_model.expfromController.text != null &&
                                      _model.expfromController.text != '') &&
                                  (_model.exptoController.text == null ||
                                      _model.exptoController.text == '')) ||
                              ((_model.expfromController.text == null ||
                                      _model.expfromController.text == '') &&
                                  (_model.exptoController.text != null &&
                                      _model.exptoController.text != '')) ||
                              ((_model.salaryminController.text != null &&
                                      _model.salaryminController.text != '') &&
                                  (_model.salarytillController.text == null ||
