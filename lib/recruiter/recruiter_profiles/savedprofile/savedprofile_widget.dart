...
class SavedprofileWidget extends StatefulWidget {
  const SavedprofileWidget({super.key});

  @override
  State<SavedprofileWidget> createState() => _SavedprofileWidgetState();
}

class _SavedprofileWidgetState extends State<SavedprofileWidget> {
  late SavedprofileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavedprofileModel());
